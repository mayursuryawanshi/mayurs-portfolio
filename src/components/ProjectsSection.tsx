...
const projects = [
  {
    title: "Project One",
    description: "A modern web application built with React and Node.js. Features real-time updates and beautiful UI.",
  ...
  {
    title: "Project Three",
    description: "Mobile-first dashboard for analytics and data visualization with interactive charts.",
  ...
  {
    title: "Project Four",
    description: "AI-powered content management system with automated workflows and smart suggestions.",
    ...
    <section id="projects" className="py-20 px-4 relative">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-12">
          <div>
            <Badge variant="outline" className="neo-tag bg-neo-cyan mb-4 px-4 py-2">
              <span className="w-3 h-3 rounded-full bg-foreground mr-2" />
              <span className="font-body text-sm tracking-widest uppercase">My Work</span>
            </Badge>
            <h2 className="font-display text-4xl md:text-5xl">Featured Projects</h2>
          </div>
          <Button asChild className="neo-button bg-primary text-foreground font-body h-auto py-3 px-6 self-start">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <Card
              key={project.title}
              className="neo-card bg-neo-cream overflow-hidden group border-0"
            ...
            >
              ...
              <CardContent className="p-6">
                ...
                <div className="flex gap-3">
                  <Button asChild size="sm" className="neo-button bg-primary text-foreground font-body">
                    <a href={project.liveUrl} className="flex items-center gap-2">
                      Live Demo <ExternalLink className="w-4 h-4" />
                    </a>
                  </Button>
                  <Button asChild size="sm" variant="secondary" className="neo-button bg-secondary text-foreground font-body">
      ...
      {/* Decorative */}
      <div className="absolute bottom-20 left-5 hidden xl:block">
